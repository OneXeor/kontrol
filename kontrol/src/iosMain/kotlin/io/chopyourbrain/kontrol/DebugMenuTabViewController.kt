...
class DebugMenuTabViewController @OverrideInit constructor(
    ...
    override fun viewDidLoad() {
        ...
        debugViewController.tabBarItem =
            UITabBarItem("Properties", UIImage.systemImageNamed("slider.horizontal.3"), 0L)
        ...
        if (ServiceLocator.DBRepository.value != null) {
            ...
            networkViewController.tabBarItem =
                UITabBarItem(
                    "Network",
                    UIImage.systemImageNamed("antenna.radiowaves.left.and.right"),
                    1L,
                )
